...
export const officialImages: OfficialImage[] = [
	{
		...
		iconColor: '#3b82f6',
		description:
			'First-class Stack integration. Optimized kernel, automatic updates, and built-in monitoring agent.',
		paid: false,
		versions: [
	...
	},
	{
		...
		description:
			'Enterprise-grade stability with 10-year lifecycle, certified hardware support, and Red Hat support portal access.',
		paid: true,
		price: '$14/mo',
		versions: [
			{ version: '9.4', archs: ['x86_64', 'aarch64'], size: '1.9 GB', type: 'iso' },
