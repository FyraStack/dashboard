...
export function getRuntimeEnv(): RuntimeEnv {
	...
	if (platformEnv) {
		return {
			...
			BILLING_DISABLED: platformEnv.BILLING_DISABLED,
	...
	return {
		...
		BILLING_DISABLED: privateEnv.BILLING_DISABLED,
		...
		AUTUMN_CREDITS_FEATURE_ID: privateEnv.AUTUMN_CREDITS_FEATURE_ID,
